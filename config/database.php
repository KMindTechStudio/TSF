...
function db(): PDO
{
    ...
    if ($pdo === null) {
        ...
        if (file_exists(__DIR__ . '/../database/seeder.php')) {
            require_once __DIR__ . '/../database/seeder.php';
        }
        if (file_exists(__DIR__ . '/../database/fix_tc.php')) {
            require_once __DIR__ . '/../database/fix_tc.php';
        }
        if (file_exists(__DIR__ . '/../database/seed_files.php')) {
            require_once __DIR__ . '/../database/seed_files.php';
        }
    }
