...
if (isset($_GET['export']) && $_GET['export'] === 'excel') {
    ...
    $columns = [
        ['key' => 'code', 'label' => 'Mã tiêu chuẩn', 'align' => 'center', 'width' => '130px'],
        ['key' => 'name', 'label' => 'Tên tiêu chuẩn', 'align' => 'left', 'width' => '320px'],
        ['key' => 'description', 'label' => 'Mô tả', 'align' => 'left', 'width' => '350px'],
        ['key' => 'set_code', 'label' => 'Mã bộ tiêu chuẩn', 'align' => 'center', 'width' => '150px'],
    ];

    export_to_excel('danh_sach_tieu_chuan_' . date('Ymd_His') . '.xls', 'DANH SÁCH TIÊU CHUẨN KIỂM ĐỊNH', $columns, array_values($standards));
}
        ...
        <div class="panel standards-list-panel">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary" id="exportExcelBtn" href="<?= base_url('admin/standards.php?export=excel' . ($searchKeyword !== '' ? '&search=' . urlencode($searchKeyword) : '')) ?>"><i class="bi bi-file-earmark-spreadsheet me-1"></i> Xuất Excel</a>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (exportBtn && searchInput) {
        exportBtn.addEventListener('click', function (e) {
            ...
            let url = '<?= base_url('admin/standards.php?export=excel') ?>';
            if (keyword) {
