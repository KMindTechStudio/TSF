...
Object.assign(translations.en, {
    ...
    'Chuẩn hóa lưu trữ, tìm kiếm, thống kê và khai thác minh chứng cho Trường Đại học Tài chính - Ngân hàng Hà Nội.': 'Standardize storage, search, reporting, and access to evidence for Hanoi Financial and Banking University.',
    ...
    'Tìm kiếm minh chứng': 'Search Evidence',
    'Tìm kiếm và lọc minh chứng': 'Search & Filter Evidence',
    'Không gian tìm kiếm và lọc minh chứng': 'Evidence Search & Filter Space',
    ...
    'Người dùng tìm kiếm': 'Search User',
    ...
    'Đơn vị cung cấp': 'Issuing Department',
    'Đơn vị phụ trách': 'Responsible Unit',
    'Đơn vị cung cấp / phụ trách': 'Issuing / Responsible Department',
    'Loại minh chứng': 'Evidence Type',
    'Minh chứng chính': 'Primary Evidence',
    'Minh chứng bổ sung': 'Supplementary Evidence',
    'Minh chứng tham khảo': 'Reference Evidence',
    'Thuộc tiêu chí': 'Belongs to Criteria',
    ...
    'Lọc mô tả': 'Filter description',
    'Lọc ngày ban hành': 'Filter issue date',
    'Lọc ngày': 'Filter date',
    'Lọc đơn vị cung cấp': 'Filter issuing department',
    'Lọc đơn vị': 'Filter department',
    'Lọc loại minh chứng': 'Filter evidence type',
    ...
    'Minh chứng đã cập nhật': 'Updated Evidence',
    'Tổng số minh chứng trên hệ thống': 'Total evidence in system',
    'Tiêu chí cần bổ sung': 'Criteria Needing Supplement',
    'Tiêu chí thiếu minh chứng': 'Criteria Missing Evidence',
    'Xuất PDF báo cáo': 'Export PDF Report',
    'Số lượng minh chứng theo tiêu chí (Nhiều nhất)': 'Evidence Count by Criteria (Top)',
    'Số lượng minh chứng theo tiêu chí': 'Evidence Count by Criteria',
    'Số lượng minh chứng theo năm học': 'Evidence Count by Academic Year',
    'Số lượng minh chứng theo đơn vị': 'Evidence Count by Department',
    'Chưa có dữ liệu minh chứng.': 'No evidence data available.',
    'Xem chi tiết tất cả tiêu chí →': 'View all criteria details →',
    'Mã: “': 'Code: “',
    'Tên: “': 'Name: “',
    'Không tìm thấy minh chứng phù hợp. Vui lòng thử từ khóa hoặc bộ lọc khác.': 'No matching evidence found. Please try other keywords or filters.',
    'Kết quả tra cứu': 'Search Results',
    'Kết quả tìm kiếm': 'Search Results',
    'Tìm kiếm & Lọc': 'Search & Filter',
    'Tìm kiếm thêm': 'Search More',
    'Tiêu chuẩn': 'Standard',
    'Tiêu chí': 'Criteria',
    'Minh chứng': 'Evidence',
    'Tỷ lệ đáp ứng': 'Compliance Rate',
    'Bộ tiêu chuẩn đang áp dụng': 'Active standard set',
    'Tổng số tiêu chí đánh giá': 'Total evaluation criteria',
    ...
    'Tìm kiếm và khai thác minh chứng': 'Search and Access Evidence',
    ...
    'Xuất PDF': 'Export PDF',
    'Tất cả tiêu chuẩn': 'All Standards',
    'Tất cả tiêu chí': 'All Criteria',
    'Tất cả đơn vị': 'All Departments',
    'Tất cả năm học': 'All Academic Years',
    'Tất cả loại file': 'All File Types',
    'Từ khóa / Mã / Tên': 'Keyword / Code / Name',
    'Tra cứu và khai thác minh chứng': 'Search and Access Evidence',
    'Từ khóa': 'Keyword',
    'Loại file': 'File Type',
